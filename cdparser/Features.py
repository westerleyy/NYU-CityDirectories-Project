...
from cdparser.KnownDictionaries import *

StreetDict = StreetNames()
OccDict = OccupationNames()
NameDict = PersonalNames()
...
class Features:
    ...
    def get_word_features(sentence,i):
        features = {}
        features.update({"word.segmentsentence": Features.__segment_of_sentence(sentence, i, 3)})
    ...
    def __word_feature_functions():
        return {
            ...
            "word.is.knownstreet":Features.__is_known_streetname
            #"word.is.knownname": Features.__is_known_personalname,
            #"word.is.knownocc": Features.__is_known_occname,
        }
    ...
    @staticmethod
    def __is_known_streetname(input):
        try:
            if input in StreetDict.checkstreet(input):
                return True
        except:
            return False
        return False
    ...
    @staticmethod
    def __is_known_personalname(input):
        try:
            if input in NameDict.checkname(input):
                return True
        except:
            return False
        return False
    ...
    @staticmethod
    def __is_known_occname(input):
        try:
            if input in OccDict.checkocc(input):
                return True
        except:
            return False
        return False
