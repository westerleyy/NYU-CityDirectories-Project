...
# The previous team used PIL and PyTesseract to parse through the images. I decided to use PIL and PyTesseract instead of Image Magick as it seems more straightforward than using ImageMagick whose API has not been updated for a while, it seems. 
# 
# At this stage, I am also working with OpenCV to enhance edge detection and image cropping before running OCR on it. 
